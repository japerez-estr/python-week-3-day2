...
age="15"
name="jose"
song="Don't Kill Moths - Manwolves"
food="Pasta"
number=1823
...
print(f"{name} liked to hum the song {song} while conding. It was so annoying that their teammates would throw {food} until {name} would stop singing.")
...
# type() identifies the type of data type
...
print("You have $" + str(total_cost) + " for the movie and dinner.")
...
# implicit means its inferred already by the program EX if you do decimal_num=62.74
# explicit means it is specifically defined EX if you do decimal_num=float(62.74)
